...
const modelosEtiquetas = [
  ...
  },
  {
    ...
    espacamentoVerticalMm: 0,
    observacao: 'Etiqueta grande',
  },
  {
    id: 'pimaco-a4375',
    nome: 'PIMACO A4375 / A4',
    ...
    espacamentoVerticalMm: 0,
    observacao: 'Ideal para nomes longos',
  },
  {
    id: 'rs-brasil-16',
    nome: 'RS BRASIL 16',
    ...
    espacamentoHorizontalMm: 3.2,
    espacamentoVerticalMm: 0,
    observacao: 'Tamanho personalizado',
  },
  {
    id: 'pimaco-a4256',
          ...
          <RadioGroup value={modeloSelecionado} onValueChange={setModeloSelecionado}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {modelosEtiquetas.map((modelo) => {
                // Escala para caber bem no preview
                const escala = 0.35;
