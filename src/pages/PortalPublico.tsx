...
const PortalPublico = () => {
  ...
  const loadPortal = async () => {
    ...
    try {
      // Buscar portal publicado pelo slug
      ...
      if (!data) {
        setError('Portal não encontrado ou não está publicado');
        return;
      }
      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="text-center space-y-4 max-w-md">
          ...
          <p className="text-muted-foreground">
            {error || 'O portal que você está procurando não existe ou não está mais disponível.'}
          </p>
